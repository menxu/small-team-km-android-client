...
//            }
	...
	private void set_list_view_height() {
		ListViewUtility.setListViewHeightBasedOnChildren(search_history);
		ListViewUtility.setListViewHeightBasedOnChildren(search_result_list);
	}
}
